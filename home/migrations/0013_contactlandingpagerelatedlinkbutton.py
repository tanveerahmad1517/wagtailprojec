    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_link_buttons', to='home.Contact')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
