...
from home.models import Advert, JobIndexPage, MainMenu
from home.utils import roundrobin
...
@register.inclusion_tag('home/tags/homepage_people_listing.html', takes_context=True)
...
@register.inclusion_tag('home/tags/homepage_blog_listing.html', takes_context=True)
def homepage_blog_listing(context, count=6):
    blog_posts = BlogPage.objects.filter(live=True)[:count]
    return {
...
@register.inclusion_tag('home/tags/homepage_work_listing.html', takes_context=True)
...
@register.inclusion_tag('home/tags/homepage_job_listing.html', takes_context=True)
...
@register.inclusion_tag('home/tags/person_blog_listing.html', takes_context=True)
...
@register.inclusion_tag('home/tags/work_and_blog_listing.html', takes_context=True)
